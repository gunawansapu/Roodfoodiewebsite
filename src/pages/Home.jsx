...
const images = [
  ...
  "https://images.unsplash.com/photo-1680674774705-90b4904b3a7f?w=600&auto=format&fit=crop&q=60",
...
function Home() {
  ...
  return (
    <div className="bg-[url('https://www.transparenttextures.com/patterns/food.png')] bg-repeat bg-white dark:bg-gray-900 transition-colors duration-500">
      ...
      <div className="max-w-6xl mx-auto py-16 px-4 space-y-24">
        ...
        >
          <motion.div variants={fadeInLeft}>
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-4 relative pl-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 text-lg pl-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {menuAndalan.map((item) => (
              ...
              >
                <div className="overflow-hidden rounded-lg shadow-md hover:shadow-xl transition bg-white dark:bg-gray-800">
                  <img
                    src={item.img}
                    alt={item.title}
                  ...
                  />
                  <div className="p-4">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-white group-hover:text-red-600 transition">
                      {item.title}
                    </h3>
                  </div>
                </div>
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="text-5xl mb-4">{item.icon}</div>
                <h3 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Langkah {item.step}</h3>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link to="/contact"
              className="bg-blue-500 text-white px-6 py-3 rounded-full hover:bg-yellow-400 transition">
              Kontak Kami
            </Link>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="w-full rounded-lg overflow-hidden shadow-lg border border-gray-300 dark:border-gray-700">
              <iframe
                ...
                style={{ border: 0, filter: "grayscale(30%) brightness(90%)" }}
                allowFullScreen=""
                loading="lazy"
