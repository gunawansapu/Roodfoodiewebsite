...
>
  <defs>
    ...
    >
      ...
      <path
        ...
        fill="none"
        stroke="rgba(239, 68, 68, 0.08)" // merah soft dan sangat transparan
        strokeWidth="0.8"
      />
      {/* Telepon halus */}
      <circle
  ...
  />
      ...
      {/* Info kontak */}
      <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded shadow-lg flex flex-col justify-center relative z-10">
