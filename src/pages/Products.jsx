...
>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="flex items-center w-full sm:w-1/2 bg-white dark:bg-gray-700 border-2 border-indigo-500 rounded-full px-4 py-2 shadow-lg focus-within:ring-2 focus-within:ring-indigo-600 transition-all duration-300">
            ...
            <select
              ...
              className="w-full sm:w-1/4 bg-white dark:bg-gray-700 text-sm text-gray-800 dark:text-gray-100 border-2 border-indigo-500 rounded-full px-4 py-2 shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 transition-all duration-300"
            >
              {categories.map((cat) => (
                ...
                <Parallax key={id} speed={3}>
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="font-bold text-blue-600 dark:text-blue-400 mb-4">Rp {price.toLocaleString()}</p>
                      <Link to={`/products/${id}`}>
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
